...
const VehiclePanel = ({setVehiclePanelOpen,setConfirmRidePanel,vehiclePanelCloseRef}) => {
  return (
    <div>
         <h5 
           ...
           className='flex w-full p-3 border-2 mb-2 border-black rounded-xl items-center justify-between'>
            <img className='h-14' src="https://th.bing.com/th/id/OIP.ymjpxr4RPlwbLenCbbpYywHaE7?rs=1&pid=ImgDetMain" alt="" />
            ...
            <h4 className='font-medium text-lg'>₹ 199</h4>
           </div>
           ...
           className='flex w-full p-3 border-2 mb-2 border-black rounded-xl items-center justify-between'>
            ...
            <h4 className='font-medium text-lg'>₹ 65</h4>
           </div>
           ...
           className='flex w-full p-3 border-2 mb-2 border-black rounded-xl items-center justify-between'>
            ...
            <h4 className='font-medium text-lg'>₹ 99</h4>
           </div>
    </div>
  )
}
